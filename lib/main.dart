...
class MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void setUpDbEmulatorIfPossible() {
    const String localDbHost = String.fromEnvironment("FIREBASE_DB_HOST");
    const int localDbPort = int.fromEnvironment("FIREBASE_DB_PORT");
  ...
  void setUpAuthEmulatorIfPossible() {
    const String localAuthHost = String.fromEnvironment("FIREBASE_AUTH_HOST");
    const int localAuthPort = int.fromEnvironment("FIREBASE_AUTH_PORT");
  ...
  void setUpFirestoreEmulatorIfPossible() {
    const String localFsHost = String.fromEnvironment("FIREBASE_FSTORE_HOST");
    const int localFsPort = int.fromEnvironment("FIREBASE_FSTORE_PORT");
