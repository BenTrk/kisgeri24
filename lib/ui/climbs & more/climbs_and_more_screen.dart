...
class _ClimbsAndMoreScreenState extends State<ClimbsAndMoreScreen> {
  ...
  void handlePlaceSelected(ClimbedPlace place) {
    setState(() {
      ...
      climbedPlaces;
      if (results.climberOneResults.climberName ==
                              ...
                              ToggleButtons(
                                ...
                                onPressed: (index) {
                                  ...
                                  setState(() {
                                    ...
                                    selectedClimber = index == 0
                                        ? SelectedClimber.climberOne
                                        : SelectedClimber.climberTwo;
                                    if (results.climberOneResults.climberName ==
                                        climbers[selectedClimber.index]) {
                                      climbedPlaces = results.climberOneResults;
                                    } else {
...
class _DisplayDidActivitiesState extends State<DisplayDidActivities> {
  ...
  @override
  Widget build(BuildContext context) {
    if (didActivities.activitiesList.isNotEmpty ||
        teamResults.teamResultList.isNotEmpty) {
      return ListView.builder(
          itemCount: didActivities.activitiesList.length +
              teamResults.teamResultList.length,
