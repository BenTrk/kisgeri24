...
class OptionsModel{
  ...
  static void deleteUser(BuildContext context, String emailToDelete, String passwordToDelete) async {
        try {
          ...
          showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                ...
                content: const Text('There was an error authenticating. Please check your email and password.'),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
