...
class SponsorsRandomSponsorScreen extends StatefulWidget {
  ...
  const SponsorsRandomSponsorScreen(
...
class _SponsorsRandomSponsorScreenState extends State<SponsorsRandomSponsorScreen> {
  late User user;
...
class SponsorsRandomSponsorScreenTitleWidget extends StatelessWidget {
  final User user;

  const SponsorsRandomSponsorScreenTitleWidget({
    super.key,
    required this.user,
  });
