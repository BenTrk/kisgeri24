...
class OverviewBloc extends Bloc<OverviewEvent, OverviewState> {
  ...
  Future<void> _createTestResult({bool create = false}) async {
    if (create) {
      ...
      await resultService.saveActivityResult(teamResultForYuli);
      ...
      await resultService.updateRouteResult(teamResultForYuli);
      ...
      await resultService.saveActivityResult(resultForSanyi);
