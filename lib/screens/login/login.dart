...
import "package:kisgeri24/screens/login/forgot_password.dart";
import "package:kisgeri24/screens/login/reset_password.dart";
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ForgotPasswordFigma(),
                    ),
                  );
              ...
              child: OutlinedButton(
                ...
                onPressed: () async {
                  ...
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ResetPasswordFigma(),
                    ),
                  );
