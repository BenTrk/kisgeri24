...
class AuthenticationBloc
  ...
  AuthenticationBloc({this.user})
    ...
    final Auth authenticator = Auth(FirebaseSingletonProvider.instance.authInstance,
    ...
    on<LoginWithEmailAndPasswordEvent>((event, emit) async {
      final dynamic result = await authenticator.login(event.email, event.password);
      if (result != null &&
          result is User &&
    ...
    on<SignupWithEmailAndPasswordEvent>((event, emit) async {
      final dynamic result = await authenticator.signUpWithEmailAndPassword(
    ...
    on<CheckAuthenticationEvent>((event, emit) async {
      final User? user = await authenticator.getAuthUser();
      if (user != null) {
