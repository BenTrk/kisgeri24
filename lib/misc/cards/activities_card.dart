                        ...
                        child: Column(
                          children: [
                            ToggleButtons(
                              ...
                              isSelected: widget.valueMap.keys
                                  .map((key) => key == selectedItemValue)
                                  .toList(),
                              onPressed: (index) {
                                setState(() {
                                  selectedItemValue =
                                      widget.valueMap.keys.toList()[index];
                                  log(selectedItemValue.toString());
                                });
                              },
                              children: widget.valueMap.keys
                                  .map((key) => Text(key))
                                  .toList(),
                            ),
                                  ...
                                  onPressed: (index) {
                                    setState(() {
                                      ...
                                      selectedItem = index == 0
                                          ? SelectedItem.climberOne
                                          : SelectedItem.climberTwo;
                                    });
                                  },
                                  children: [
