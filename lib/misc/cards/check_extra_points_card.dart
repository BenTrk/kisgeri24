            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(widget.teamResult.action, style: const TextStyle(color: Color(colorPrimary), fontSize: 16, fontWeight: FontWeight.w600)),
                ],
              ),
            ),
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text('Points earned: ${widget.teamResult.points}', style: TextStyle(color: Colors.grey.shade800, fontSize: 16, fontWeight: FontWeight.w500)),
                ),
              ],
            ),
          ],
