...
class ResultService {
  ...
  final Converter<RouteResultDto, RouteResult> _routeResultDtoToRouteResultConverter;

  final Converter<TeamResult, TeamResultDto> _teamResultToTeamResultDtoConverter;
  ...
  ResultService(
    ...
    this._teamResultToTeamResultDtoConverter,
    this._teamResultDtoToTeamResultConverter,
    this._routeResultDtoToRouteResultConverter,
  );

  Future<void> saveRouteResult(String teamId, String competitorName,
      RouteResultDto result,) async {
    await _resultRepository.saveRouteResult(
      teamId,
      competitorName,
      result.routeId,
      _routeResultDtoToRouteResultConverter.convert(result),
    );
  }

  Future<void> updateRouteResult(TeamResultDto result) async {
    await _resultRepository
        .update(_teamResultDtoToTeamResultConverter.convert(result));
  }

  Future<void> saveActivityResult(TeamResultDto result) async {
  ...
  Future<TeamResultDto?> getResultByTeamId(String teamId) async {
    ...
    return result == null ? null : _teamResultToTeamResultDtoConverter.convert(result);
  }
}
